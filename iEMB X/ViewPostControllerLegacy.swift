//
//  ViewPostControllerLegacy.swift
//  iEMB X
//
...
class ViewPostControllerLegacy: UIViewController {
    ...
    func updateUI(animated flag: Bool) {
        ...
        func applyAnimatables() {
            ...
            self.rightButton.alpha = post.canReply ? 1:0
    ...
    @objc func rightButtonClicked() {
        if isReplying {
            ...
            post.sendReply(option: option, content: responseTextView.text) { error in
...
extension ViewPostControllerLegacy: UITableViewDataSource, UITableViewDelegate {
...
extension ViewPostControllerLegacy: UIGestureRecognizerDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        guard post.canReply && !isReplying else {
            return
        }
